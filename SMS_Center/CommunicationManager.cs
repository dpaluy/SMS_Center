...
namespace SMS_Center
{
    public class CommunicationManager
    {
        ...
        public const string NO_COM_PORT = "NO COM PORT";
        #endregion
        ...
        public bool SetPortNameValues(object obj, string defaultValue)
        {
            ...
            if (ports.Length > 0)
            {
                foreach (string str in ports)
                {
                    ...
                    if (str == defaultValue)
                    {
                        ((ComboBox)obj).Text = defaultValue;
                        defaultSet = true;
                    }
                }
                if (false == defaultSet)
